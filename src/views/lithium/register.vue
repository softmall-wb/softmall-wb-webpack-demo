<template>
  <div wb:style-var-bind>
    <div
      :style="{'background-image': 'url('+ theme_background_img+ '@w_750,h_750)'}"
      class="register"
    >
      <div class="logo_title">欢迎注册{{ mall_name }}</div>
      <ul class="register-form">
        <!-- 用户名 -->
        <li class="form-item form-input" v-if="need_username">
          <div class="icon">
            <icon-base :width="iconSize" :height="iconSize" iconColor>
              <user-icon />
            </icon-base>
          </div>
          <input
        ...
        <!-- 密码 -->
        <li class="form-item form-input" v-if="need_password">
          <div class="icon">
            <icon-base :width="iconSize" :height="iconSize" iconColor>
              <password-icon />
            </icon-base>
        ...
        <!-- 微信-->
        <li class="form-item form-input" v-if="need_wechat">
          <div class="icon">
            <icon-base :width="iconSize" :height="iconSize" iconColor>
              <wechat-icon />
            </icon-base>
        ...
        <!-- 邮箱-->
        <li class="form-item form-input" v-if="need_mail">
          <div class="icon">
            <icon-base :width="iconSize" :height="iconSize" iconColor>
              <mail-icon />
            </icon-base>
        ...
        <!-- QQ-->
        <li class="form-item form-input" v-if="need_qq">
          <div class="icon">
            <icon-base :width="iconSize" :height="iconSize" iconColor>
              <qq-icon />
            </icon-base>
        ...
        <!-- 支付宝-->
        <li class="form-item form-input" v-if="need_alipay">
          <div class="icon">
            <icon-base :width="iconSize" :height="iconSize" iconColor>
              <alipay-icon />
            </icon-base>
        ...
        <li class="form-item form-input">
          ...
          <button
            id="get-captcha"
            @click="sendCode"
          >{{!registerService.able_to_send_vcode? registerService.vcode_second: '获取验证码'}}</button>
        </li>
        <!-- 验证码-->
        ...
        <li class="form-item submit">
          <div @click="submit" class="form-submit">
            <icon-base :width="40" :height="40" iconColor>
              <enter-icon />
            </icon-base>
          </div>
        </li>
...
import enterIcon from "../../components/icons/enter.vue";
...
export default {
  ...
  props: {
    ...
    submit_button_size: new WBPropertyUtil.PixelSlider(
      "注册按钮",
      "按钮大小",
      80,
      50,
  ...
  methods: {
    ...
    sendCode() {
      if (!this.registerService.able_to_send_vcode) return;
...
@import "src/views/lithium/var.scss";
@import "src/views/lithium/public.scss";
.register {
  min-height: 100vh;
  display: flex;
...
.avatar-upload-icon {
  ...
  align-items: center;
  border: 1px dashed $upload_avatar_font_color;
  border-radius: 4px;
}
